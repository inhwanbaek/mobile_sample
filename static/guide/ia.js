...
var ia = {
	...
	stats:function(){
		...
		$(".ia-body table td.urls a").each(function () {
			...
			if( $(this).attr('href').indexOf("javascript:") < 0   ) $(this).text(  $(this).attr('href').replace("../../html",".")  );
		});
	...
	total:{
		init:function(){
			...
			'<ul class="info tot">'+
				...
				'<li>대기중 <span class="sty">0</span></li>'+
				'<li>진행중 <span class="ing">0</span></li>'+
				'<li>검수중 <span class="chk">0</span></li>'+
				'<li>완료됨 <span class="com">0</span></li>'+
				'<li>삭제됨 <span class="del">0</span></li>'+
			...
			'<ul class="info usr">'+
				...
				'<li><label class="check"><input type="checkbox" name="sty" checked><i>대기중<span class="sty">0</span></i></label></li>'+
				'<li><label class="check"><input type="checkbox" name="ing" checked><i>진행중<span class="ing">0</span></i></label></li>'+
				'<li><label class="check"><input type="checkbox" name="chk" checked><i>검수중<span class="chk">0</span></i></label></li>'+
				'<li><label class="check"><input type="checkbox" name="com" checked><i>완료됨<span class="com">0</span></i></label></li>'+
				'<li><label class="check"><input type="checkbox" name="del" checked><i>삭제됨<span class="del">0</span></i></label></li>'+
				'<li><em class="graph"><i class="bar"></i></em> <span class="pct">0</span></li>'+
			'</ul>';
	...
	user:{
		...
		usrs:["백인환","김대화","김영욱","김다슬","배현정","최지은","임영범","최윤미","김향희","오승남","임혜옥","박성준","이상민","임하나","주다영","박지우","신용섭","김기현","미지정"],
	...
	mact:function(num){
		...
		var path = location.pathname.split("/");
		path = path[path.length - 4];
		var active = { "mo":"mo", "pc":"pc", "admin":"admin" ,"sm":"sm"};
